...
function gotonewworld()
	...
	SetTask(PLAYER_MAP_TASK, SubWorldIdx2ID(nMapIndex)) -- L­u L¹i ID B¶n §å HiÖn T¹i Cña Ng­êi Ch¬i
	-- ´Ó\\settings\\maps\\liandandong\\npc_3.txtÖÐÑ¡ÔñµÄÒ»¸öÎ»ÖÃ
	NewWorld(CHUANGGUAN30_MAP_ID, floor(51072/32), floor(102272/32))	-- TruyÒn tèng ®Õn b¶n ®å míi
end
