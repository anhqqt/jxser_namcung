...
function QuanLyTK_Say(szTitle)
    local tbOpt = {
        ...
        {"Reset EXP tuÇn", QuanLyTK_ResetExpTuan},
...
function QuanLyTK_ResetExpNgay()
    ...
    Msg2Player("<color=yellow>§· reset giíi h¹n EXP quy ®æi trong ngµy vÒ <color=green>0<color><color>")
end

function QuanLyTK_ResetExpTuan()
    SetTask(1017, 0)
    Msg2Player("<color=yellow>§· reset giíi h¹n EXP quy ®æi trong tuÇn vÒ <color=green>0<color><color>")
end
