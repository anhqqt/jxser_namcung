...
function about_rename_role()
    local strInfo = "<color=green>Ch©n Nhi:<color> Chµo b¹n! V× tªn nh©n vËt cña b¹n vµ ng­êi ch¬i kh¸c gièng nhau, cho nªn hÖ thèng ®· gióp b¹n ®æi tªn, b¹n cã thÓ söa tªn nh©n vËt cña b¹n tr­íc ®©y, cã thÓ kiÓm tra xem tªn ®ã cã dïng ®­îc kh«ng. Chó ý! B¹n chØ cã 1 c¬ héi duy nhÊt ®Ó ®æi tªn, xin h·y cÈn thËn tõng b­íc.";
...
function dangkydoiten()
    if (GetBit(GetTask(TASKVALUE_BLEND), 1) == 1) then
		Say("<color=green>Ch©n Nhi:<color> B¹n vÉn cßn 1 lÇn ®æi tªn nh©n vËt. H·y chän '§Æt l¹i tªn cho nh©n vËt' ®Ó ®æi tªn nh©n vËt",
        1,
		"§Ó ta kiÓm tra xem sao/cancel")
        return
    end
	Say("<color=green>Ch©n Nhi:<color> Mçi lÇn ®æi tªn nh©n vËt cÇn <color=red>100 tiÒn ®ång<color>, ng­êi chuÈn bÞ xong ch­a?",
		2,
		"Ta ®· chuÈn bÞ xong/dongkymua",
...
function buy_addibox_yes(nNedCount)
    ...
    if (nCount < nNedCount) then
		Say("<color=green>Ch©n Nhi:<color> Kh¸ch quan ch­a ®ñ 100 tiÒn ®ång! Khi nµo cã ®ñ tiÒn h·y quay l¹i.",
        1,
		"§Ó ta kiÓm tra xem sao/cancel")
        return
    end
