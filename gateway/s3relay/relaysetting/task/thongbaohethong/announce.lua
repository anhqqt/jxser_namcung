...
g_strFutureMsg = {
    "9 nguyÖt phong ba ho¹t ®éng ®ang tiÕn hµnh, mçi ngµy, mçi tuÇn, mçi th¸ng ®Òu cã th­ëng cho chê ng­¬i. Tõ ®¸o trong thêi gian, tham gia ho¹t ®éng, tû nh­ tèng kim ®¹i chiÕn, d· tÈu nhiÖm vô, s¸t thñ nhiÖm vô ®Òu cã thÓ tèng vi tÝch lòy. Cã thÓ ®i kiÕn vâ l©m truyÒn thô cã lÏ ë trang chÝnh kh¸n t×nh h×nh cô thÓ vµ tØ mØ ",
    "9 nguyÖt phong ba ho¹t ®éng ®ang tiÕn hµnh, mçi ngµy vi tÝch lòy kh¶ dÜ ®æi lÊy th­ëng cho, cô thÓ nh­ sau: Mçi tuÇn tæng vi tÝch lòy bµi danh tiÒn m­êi ngo¹n gia t­¬ng thu ®­îc chu th­ëng cho, toµn bé ho¹t ®éng trong lóc, tæng vi tÝch lòy bµi danh tiÒn m­êi, t­¬ng thu ®­îc nguyÖt th­ëng cho. Qu¸n qu©n th­ëng cho vi ®¹i m· n·o nhÉn th­ëng cho cã lÏ ngÉu nhiªn thu ®­îc mét bé ®¹i hoµng kim trang bÞ, kü n¨ng + 1!",
...
function getFutureMsg()
    ...
    str = "";
    if (g_nFutureDate > nCurDate) then -- Cã ph¶i tr­íc ngµy chØ ®Þnh, nÕu kh«ng th× kh«ng göi
